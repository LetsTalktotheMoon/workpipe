...
## About the job
Environmental Science Associates (ESA) is a 100% employee-owned environmental consulting firm. They are seeking a skilled Mid-Level Software Engineer to join their Corporate Technology Services AI Development Team, focusing on developing scalable web applications and services that support both client-facing and internal operational excellence.
...
- Proficient in modern web application development, including HTML
...
- Solid back-end development experience with familiarity in technologies such as C#, .NET Core
- SQL
- Docker, and API-driven architectures
...
- Experience with integrating large language model APIs
- Python, pyspark
- RAG
- LangChain/LangGraph
- MCP, and working with embeddings and search
...
- APIs, and data workflows using inputs such as user stories, acceptance criteria, wireframes, prototypes, and high-fidelity designs
- Contribute to the configuration, integration, testing, deployment, and support of web applications
- APIs, databases, and data-driven features, including AI-enabled functionality where appropriate
...
- Collaborate closely with cross-functional teams—including software engineers
- UX designers, data specialists, and Product Owners—within Agile delivery frameworks
...
**Apply:** https://www.linkedin.com/jobs/view/4397342729
**Source:** https://www.linkedin.com/jobs/view/4397342729
