...
**统计**: 原始共 844 个小标题段落，去重后剩余 293 个唯一段落，其中重复出现 551 次。

---

<!-- UID: sec-75dc134efd02521b -->
<!-- 出现于 1 处: runtime_main::generate::writer::standard_writer::examplecorp::system -->
...
<!-- UID: sec-7acd391afc8a82ba -->
<!-- 出现于 8 处: runtime_main::generate::writer::standard_writer::examplecorp::candidate_context, runtime_main::generate::writer::bytedance::standard_writer::bytedance::candidate_context, match_pipe::no_starter::writer::candidate_context_shared_experience... -->
## 候选人经历框架（⚡=不可变字段，其余可由 Writer 决定）

---

<!-- UID: sec-09aa04b1da402cbb -->
<!-- 出现于 2 处: runtime_main::generate::writer::standard_writer::examplecorp::candidate_context, runtime_main::generate::writer::bytedance::standard_writer::bytedance::candidate_context -->
...
<!-- UID: sec-28a2a76b4a2c04b4 -->
<!-- 出现于 1 处: runtime_main::generate::writer::standard_writer::examplecorp::candidate_context -->
...
<!-- UID: sec-516444b4c3e14806 -->
<!-- 出现于 7 处: runtime_main::generate::writer::standard_writer::examplecorp::candidate_context, match_pipe::no_starter::writer::candidate_context_shared_education, match_pipe::no_starter::writer::bytedance::candidate_context_shared_education... -->
### 教育经历（可根据 JD 方向选择列哪些）
...
<!-- UID: sec-7f5fa9a535dd790c -->
<!-- 出现于 8 处: runtime_main::generate::writer::standard_writer::examplecorp::candidate_context, runtime_main::generate::writer::bytedance::standard_writer::bytedance::candidate_context, match_pipe::no_starter::writer::candidate_context_shared_achievements... -->
### 成就（融入 Summary 第3句）
- 中国国家认证围棋二段棋手，2022年度市赛第一，2023年度市赛第三

---

<!-- UID: sec-49a74c0edfd2c773 -->
<!-- 出现于 1 处: runtime_main::generate::writer::standard_writer::examplecorp::jd_context -->
## 目标 JD 信息
**公司:** ExampleCorp
**岗位:** {title}
**角色类型:** {role_type}
...
<!-- UID: sec-0f856603f4b3b88f -->
<!-- 出现于 1 处: runtime_main::generate::writer::standard_writer::examplecorp::format_constraints -->
## 格式硬约束（违反=直接FAIL）
**结构规则**
...
<!-- UID: sec-82b5429812c8f517 -->
<!-- 出现于 2 处: runtime_main::generate::writer::standard_writer::examplecorp::plan_resume, runtime_main::generate::writer::bytedance::standard_writer::bytedance::plan_resume -->
...
<!-- UID: sec-ddceafff5d5731b2 -->
<!-- 出现于 8 处: runtime_main::generate::writer::standard_writer::examplecorp::plan_resume, runtime_main::generate::writer::bytedance::standard_writer::bytedance::plan_resume, match_pipe::no_starter::writer::writer_plan_shared_intro... -->
## 技术分配规划

---

<!-- UID: sec-15446f0e9a1d7be0 -->
<!-- 出现于 1 处: runtime_main::generate::writer::standard_writer::examplecorp::plan_resume -->
...
<!-- UID: sec-b338d33b265d792c -->
<!-- 出现于 8 处: runtime_main::generate::writer::standard_writer::examplecorp::plan_resume, runtime_main::generate::writer::bytedance::standard_writer::bytedance::plan_resume, match_pipe::no_starter::writer::writer_plan_shared_tail... -->
## SKILLS 推导（= 上述经历/项目技术列表的并集）
[按 2-4 个类别优先组织；若为满足 14 词硬上限可扩到 5 类；任何类别不得少于 4 个技术]

---

<!-- UID: sec-daa4bb864295b1fb -->
<!-- 出现于 8 处: runtime_main::generate::writer::standard_writer::examplecorp::plan_resume, runtime_main::generate::writer::bytedance::standard_writer::bytedance::plan_resume, match_pipe::no_starter::writer::writer_plan_shared_tail... -->
## 项目规划
- 项目1: 属于 [哪段经历] | 主题: [业务场景]
- 项目2: 属于 [哪段经历] | 主题: [业务场景]
...
<!-- UID: sec-1037c55d91418288 -->
<!-- 出现于 24 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
## 输出格式（header 拼写必须完全一致）

---

<!-- UID: sec-d5d84d791e86f2f9 -->
<!-- 出现于 24 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
...
<!-- UID: sec-4439a5443f952c2d -->
<!-- 出现于 24 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
## Experience

---

<!-- UID: sec-f17a8cb43db0fbd2 -->
<!-- 出现于 24 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
...
<!-- UID: sec-7bcae9297d777be0 -->
<!-- 出现于 24 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
## Education

---

<!-- UID: sec-4defb5fb9d00685d -->
<!-- 出现于 24 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
### Degree | School
*Dates*
...
<!-- UID: sec-e56cf6d050899ac0 -->
<!-- 出现于 22 处: runtime_main::generate::writer::standard_writer::examplecorp::output_contract, runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::output_contract, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::output_contract... -->
## Achievements
* China national certified Go **2-dan** — city **champion** (2022) and third place (2023).
...
<!-- UID: sec-f833bf5738a8e128 -->
<!-- 出现于 8 处: runtime_main::full_review::reviewer::standard_reviewer::examplecorp::full::system, runtime_seed_retarget::rewrite_review::reviewer::standard_reviewer::examplecorp::rewrite::system, runtime_main::full_review::reviewer::bytedance::standard_reviewer::bytedance::full::system... -->
...
<!-- UID: sec-89e522096eafd7d4 -->
<!-- 出现于 2 处: runtime_main::full_review::reviewer::standard_reviewer::examplecorp::full::context, runtime_seed_retarget::rewrite_review::reviewer::standard_reviewer::examplecorp::rewrite::context -->
## 目标 JD
...
<!-- UID: sec-2f0b566d29b7cf71 -->
<!-- 出现于 4 处: runtime_main::full_review::reviewer::standard_reviewer::examplecorp::full::context, runtime_seed_retarget::rewrite_review::reviewer::standard_reviewer::examplecorp::rewrite::context, runtime_main::full_review::reviewer::bytedance::standard_reviewer::bytedance::full::context... -->
## 待审查简历
{resume_md}

---

<!-- UID: sec-c23aee268a5fd8c2 -->
<!-- 出现于 8 处: runtime_main::full_review::reviewer::standard_reviewer::examplecorp::full::schema, runtime_seed_retarget::rewrite_review::reviewer::standard_reviewer::examplecorp::rewrite::schema, runtime_main::full_review::reviewer::bytedance::standard_reviewer::bytedance::full::schema... -->
请对以下简历进行严格的 9 维度审查，返回 JSON 格式结果。

---

<!-- UID: sec-2c2f3f08327dadec -->
<!-- 出现于 6 处: runtime_main::full_review::reviewer::standard_reviewer::examplecorp::full::schema, runtime_seed_retarget::rewrite_review::reviewer::standard_reviewer::examplecorp::rewrite::schema, match_pipe::reviewer::full::reviewer_user... -->
## 审查维度与权重
**R0 真实性审查 (权重 0.20)**
...
<!-- UID: sec-31b7c32ae119394b -->
<!-- 出现于 8 处: runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::system, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::system, runtime_main::upgrade_revision::writer::bytedance::standard_upgrade::bytedance::system... -->
...
<!-- UID: sec-35c6b99709f7203e -->
<!-- 出现于 4 处: runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::main, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::main, runtime_main::upgrade_revision::writer::bytedance::standard_upgrade::bytedance::main... -->
...
<!-- UID: sec-d9ab418f4320a53c -->
<!-- 出现于 6 处: runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::main, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::main, runtime_main::upgrade_revision::writer::bytedance::standard_upgrade::bytedance::main... -->
## 升级目标
...
<!-- UID: sec-abb795ac11fdd01a -->
<!-- 出现于 2 处: runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::main, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::main -->
## 关键升级规则
...
<!-- UID: sec-488e4b432046fb11 -->
<!-- 出现于 7 处: runtime_main::upgrade_revision::writer::standard_upgrade::examplecorp::resume_context, runtime_seed_retarget::rewrite_writer::writer::standard_upgrade::examplecorp::resume_context, runtime_main::upgrade_revision::writer::bytedance::standard_upgrade::bytedance::resume_context... -->
## 原始简历
{resume_md}

---

<!-- UID: sec-1e946d93d14b3e2c -->
<!-- 出现于 2 处: runtime_seed_retarget::rewrite_review::reviewer::standard_reviewer::examplecorp::rewrite::context, runtime_seed_retarget::rewrite_review::reviewer::bytedance::standard_reviewer::bytedance::rewrite::context -->
## Rewrite 审查输入说明
...
<!-- UID: sec-313e629d125385c0 -->
<!-- 出现于 5 处: runtime_main::generate::writer::bytedance::standard_writer::bytedance::system, match_pipe::no_starter::writer::writer_system, match_pipe::no_starter::writer::bytedance::writer_system... -->
你是一位专业简历撰写专家，为一家职业转型培训公司制作教学示例简历。
该候选人为虚构人物，正在从数据分析向软件工程转型。简历的「真实性」由自身逻辑自洽体现，
而非由经历或技术栈的现实核查来锚定。
...
<!-- UID: sec-25977d2488147c5a -->
<!-- 出现于 1 处: runtime_main::generate::writer::bytedance::standard_writer::bytedance::candidate_context -->
### 教育经历（可根据 JD 方向选择列哪些）
- M.S. Computer Science | Georgia Institute of Technology | Expected May 2026
  → 当 UIUC MSIM 出现时写为 M.S. Computer Science (OMSCS)；  仅出现GT时直接写 M.S. Computer Science
...
<!-- UID: sec-07eed92487725426 -->
<!-- 出现于 4 处: runtime_main::generate::writer::bytedance::standard_writer::bytedance::candidate_context, match_pipe::no_starter::writer::bytedance::candidate_context_bytedance_boundary, match_pipe::planner_write::writer::bytedance::candidate_context_bytedance_boundary... -->
### ByteDance 特殊写作边界
...
<!-- UID: sec-f3c73b1c2acc1c38 -->
<!-- 出现于 8 处: runtime_main::generate::writer::bytedance::standard_writer::bytedance::target_specific, match_pipe::no_starter::writer::bytedance::retarget_bytedance_special, match_pipe::old_match_anchor::writer::bytedance::retarget_bytedance_special... -->
## ByteDance 目标公司特殊模式
...
<!-- UID: sec-d62ded17d51b62ba -->
<!-- 出现于 1 处: runtime_main::generate::writer::bytedance::standard_writer::bytedance::jd_context -->
## 目标 JD 信息
**公司:** ByteDance
**岗位:** {title}
**角色类型:** {role_type}
...
<!-- UID: sec-efda6babac3da444 -->
<!-- 出现于 1 处: runtime_main::generate::writer::bytedance::standard_writer::bytedance::format_constraints -->
## 格式硬约束（违反=直接FAIL）
**结构规则**
- Summary: 恰好 3 句，每句格式：`* **角色定位短语:** 叙述句。`
...
<!-- UID: sec-65d442dcadb3b7fb -->
<!-- 出现于 2 处: runtime_main::full_review::reviewer::bytedance::standard_reviewer::bytedance::full::context, runtime_seed_retarget::rewrite_review::reviewer::bytedance::standard_reviewer::bytedance::rewrite::context -->
## 目标 JD
...
<!-- UID: sec-92ba4683fcee33fc -->
<!-- 出现于 4 处: runtime_main::full_review::reviewer::bytedance::standard_reviewer::bytedance::full::context, runtime_seed_retarget::rewrite_review::reviewer::bytedance::standard_reviewer::bytedance::rewrite::context, match_pipe::reviewer::full::bytedance::reviewer_context_bytedance... -->
## ByteDance 特殊审查要求
...
<!-- UID: sec-ea61a11fda6e4aa7 -->
<!-- 出现于 2 处: runtime_main::full_review::reviewer::bytedance::standard_reviewer::bytedance::full::schema, runtime_seed_retarget::rewrite_review::reviewer::bytedance::standard_reviewer::bytedance::rewrite::schema -->
## 审查维度与权重
**R0 真实性审查 (权重 0.20)**
- 不可变字段（公司/职称/时间/地点）是否与规定完全一致？
...
<!-- UID: sec-83edffb54223c5bf -->
<!-- 出现于 2 处: runtime_main::upgrade_revision::writer::bytedance::standard_upgrade::bytedance::main, runtime_seed_retarget::rewrite_writer::writer::bytedance::standard_upgrade::bytedance::main -->
## 关键升级规则
1. Summary 必须重新评估，不要默认沿用旧 phrasing；三句都要服务目标 JD
2. 如果 DiDi 的 senior operating scope 能显著增强匹配度，可以把该信号提炼进 summary，但要简洁，不要和 bullet 机械重复
3. 如果目标 JD 带有陌生行业语境，优先补一条“领域桥接”语句，说明现有平台/数据/可靠性模式如何迁移到该行业
...
<!-- UID: sec-784e02c11e44e787 -->
<!-- 出现于 3 处: runtime_main::upgrade_revision::writer::bytedance::standard_upgrade::bytedance::bytedance, runtime_seed_retarget::rewrite_writer::writer::bytedance::standard_upgrade::bytedance::bytedance, match_pipe::reviewer_followup::writer::bytedance::upgrade_bytedance_special -->
## ByteDance 特殊要求
...
<!-- UID: sec-9df28c2cddef90c7 -->
<!-- 出现于 1 处: runtime_reviewer_fallback::json_repair::reviewer_repairer::runtime_reviewer_fallback::json_repair::system -->
你是 JSON 修复器。输入是一段可能有少量格式错误的 JSON。输出必须是严格合法的 JSON 对象，不要附加解释，不要使用 Markdown code fence。

---

<!-- UID: sec-3c3f56d6fa3378ec -->
<!-- 出现于 1 处: runtime_reviewer_fallback::json_repair::reviewer_repairer::runtime_reviewer_fallback::json_repair::user -->
...
<!-- UID: sec-96724c012ee3bc11 -->
<!-- 出现于 6 处: match_pipe::no_starter::writer::candidate_context_shared_experience, match_pipe::no_starter::writer::bytedance::candidate_context_shared_experience, match_pipe::planner_write::writer::candidate_context_shared_experience... -->
### Temu — Data Analyst (不可变)
...
<!-- UID: sec-20ea8501a65dfbf2 -->
<!-- 出现于 3 处: match_pipe::no_starter::writer::candidate_context_generic_tiktok_branch, match_pipe::planner_write::writer::candidate_context_generic_tiktok_branch, match_pipe::planner_revision::writer::candidate_context_generic_tiktok_branch -->
### TikTok — Software Engineer Intern (不可变)
...
<!-- UID: sec-f195d867f174879a -->
<!-- 出现于 6 处: match_pipe::no_starter::writer::writer_jd_context, match_pipe::no_starter::writer::bytedance::writer_jd_context, match_pipe::planner_write::writer::writer_jd_context... -->
## 目标 JD 信息
**公司:** {company}
**岗位:** {title}
**角色类型:** {role_type}
...
<!-- UID: sec-d8c448bd8e4a0345 -->
<!-- 出现于 6 处: match_pipe::no_starter::writer::writer_plan_shared_intro, match_pipe::no_starter::writer::bytedance::writer_plan_shared_intro, match_pipe::planner_write::writer::writer_plan_shared_intro... -->
## 阶段一：PLAN（在此规划，不输出给最终用户）
请在 <PLAN> 标签内完成：
...
<!-- UID: sec-d4c1191f35aa0f6a -->
<!-- 出现于 3 处: match_pipe::no_starter::writer::writer_plan_generic_tiktok_branch, match_pipe::planner_write::writer::writer_plan_generic_tiktok_branch, match_pipe::planner_revision::writer::writer_plan_generic_tiktok_branch -->
...
<!-- UID: sec-2e7a8bce1f62e6c3 -->
<!-- 出现于 6 处: match_pipe::no_starter::writer::writer_plan_shared_didi_temu, match_pipe::no_starter::writer::bytedance::writer_plan_shared_didi_temu, match_pipe::planner_write::writer::writer_plan_shared_didi_temu... -->
...
<!-- UID: sec-f190f5a20109c36d -->
<!-- 出现于 6 处: match_pipe::no_starter::writer::writer_plan_shared_gt_coursework, match_pipe::no_starter::writer::bytedance::writer_plan_shared_gt_coursework, match_pipe::planner_write::writer::writer_plan_shared_gt_coursework... -->
...
<!-- UID: sec-d232f17233f5918e -->
<!-- 出现于 6 处: match_pipe::no_starter::writer::writer_plan_shared_tail, match_pipe::no_starter::writer::bytedance::writer_plan_shared_tail, match_pipe::planner_write::writer::writer_plan_shared_tail... -->
## 教育经历选择
[列出要保留的学历条目及理由]
</PLAN>
...
<!-- UID: sec-f88da7ac3fec6e79 -->
<!-- 出现于 16 处: match_pipe::no_starter::writer::format_constraints_shared_head, match_pipe::no_starter::writer::bytedance::format_constraints_shared_head, match_pipe::old_match_anchor::writer::format_constraints_shared_head... -->
## 格式硬约束（违反=直接FAIL）
**结构规则**
- Summary: 恰好 3 句，每句格式：`* **角色定位短语:** 叙述句。`
...
<!-- UID: sec-89b4da6d0800a34f -->
<!-- 出现于 8 处: match_pipe::no_starter::writer::format_constraints_branch, match_pipe::old_match_anchor::writer::format_constraints_branch, match_pipe::old_match_anchor::writer::same_company::format_constraints_branch... -->
- Experience 顺序: **严格倒序** — TikTok（2025）→ DiDi（2022-2024）→ Temu（2021-2022）
**不可变字段（绝不可修改）**
...
<!-- UID: sec-7f7f73ac0174ab3e -->
<!-- 出现于 16 处: match_pipe::no_starter::writer::format_constraints_shared_mid, match_pipe::no_starter::writer::bytedance::format_constraints_shared_mid, match_pipe::old_match_anchor::writer::format_constraints_shared_mid... -->
- 每段经历: 4-6 条 bullet，至少 1 条含量化数据
- 项目: 恰好 2 个（至少1个来自工作经历），每项目 4-6 条 bullet
- 项目位置: 项目紧跟对应经历，不单独设 `## Projects` section
- 项目背景行: 每个项目标题下必须紧接一行 `> ` 开头的 blockquote（一句话说明业务痛点/背景，不是重复项目标题），然后才是 bullet 列表
...
<!-- UID: sec-1bacd7d71a884fca -->
<!-- 出现于 16 处: match_pipe::no_starter::writer::format_constraints_shared_tail, match_pipe::no_starter::writer::bytedance::format_constraints_shared_tail, match_pipe::old_match_anchor::writer::format_constraints_shared_tail... -->
**数字合理性规则（违反 = r4 高风险）**
- 改善幅度 > 70%：必须加范围限定语，例如：
  "within team-owned service" / "on our internal dataset" / "in controlled staging tests"
- 改善幅度 > 90%：极为可疑，需降至 80% 以下，或拆分为绝对值表述（如 "from 12 min to 2 min"）
...
<!-- UID: sec-4f938bf8414714e9 -->
<!-- 出现于 3 处: match_pipe::no_starter::writer::bytedance::candidate_context_bytedance_education_branch, match_pipe::planner_write::writer::bytedance::candidate_context_bytedance_education_branch, match_pipe::planner_revision::writer::bytedance::candidate_context_bytedance_education_branch -->
→ ByteDance 目标岗位中，Georgia Tech CS coursework/projects 可以作为主要软件工程/硬件/机械工程证据来源，注意scope均为**非工业级**。

---

<!-- UID: sec-9b24755349dc3e7d -->
<!-- 出现于 8 处: match_pipe::no_starter::writer::bytedance::format_constraints_branch_bytedance, match_pipe::old_match_anchor::writer::bytedance::format_constraints_branch_bytedance, match_pipe::old_match_anchor::writer::bytedance::same_company::format_constraints_branch_bytedance... -->
- Experience 顺序: **严格倒序** — DiDi（2022-2024）→ Temu（2021-2022）
**不可变字段（绝不可修改）**
- DiDi: Senior Data Analyst | DiDi · IBG · Food | Sep 2022 – May 2024 | Beijing/Mexico
- Temu: Data Engineer | Temu · R&D · Recommendation Algorithms | Jun 2021 – Feb 2022 | Shanghai
...
<!-- UID: sec-196bd82d5e840b13 -->
<!-- 出现于 9 处: match_pipe::old_match_anchor::writer::strict_revision_system, match_pipe::old_match_anchor::writer::bytedance::strict_revision_system, match_pipe::old_match_anchor::writer::same_company::strict_revision_system... -->
你是专业简历修改专家。严格按照修改指令执行，只改指出的问题，不做额外改动。直接输出修改后的完整简历 Markdown，不要附带解释。

---

<!-- UID: sec-7215cb8089af9032 -->
<!-- 出现于 8 处: match_pipe::old_match_anchor::writer::retarget_prompt, match_pipe::old_match_anchor::writer::bytedance::retarget_prompt, match_pipe::old_match_anchor::writer::same_company::retarget_prompt... -->
...
<!-- UID: sec-8e3631ce077ff97d -->
<!-- 出现于 9 处: match_pipe::old_match_anchor::writer::retarget_project_pool, match_pipe::old_match_anchor::writer::bytedance::retarget_project_pool, match_pipe::old_match_anchor::writer::same_company::retarget_project_pool... -->
## 经验公司项目池（硬约束）
- 单篇简历最多保留 2 个项目。
...
<!-- UID: sec-3eb48ff78aa89e38 -->
<!-- 出现于 8 处: match_pipe::old_match_anchor::writer::retarget_context, match_pipe::old_match_anchor::writer::bytedance::retarget_context, match_pipe::old_match_anchor::writer::same_company::retarget_context... -->
## Seed 简历
{seed_resume_md}

---

<!-- UID: sec-548d356e9bfcdc3c -->
<!-- 出现于 2 处: match_pipe::old_match_anchor::writer::same_company::retarget_same_company, match_pipe::new_dual_channel::writer::same_company::retarget_same_company -->
## 同公司一致性模式（最高优先级）
...
<!-- UID: sec-c49434b202aa50be -->
<!-- 出现于 2 处: match_pipe::old_match_anchor::writer::bytedance::same_company::retarget_same_company_bytedance, match_pipe::new_dual_channel::writer::bytedance::same_company::retarget_same_company_bytedance -->
...
<!-- UID: sec-e38861f8c23b2c43 -->
<!-- 出现于 4 处: match_pipe::new_dual_channel::writer::dual_channel_overlay, match_pipe::new_dual_channel::writer::bytedance::dual_channel_overlay, match_pipe::new_dual_channel::writer::same_company::dual_channel_overlay... -->
...
<!-- UID: sec-0b629d3c8ba250ee -->
<!-- 出现于 4 处: match_pipe::reviewer::full::reviewer_context, match_pipe::reviewer::full::bytedance::reviewer_context, match_pipe::planner_direct_review::reviewer::reviewer_context... -->
## 目标 JD
...
<!-- UID: sec-ef083a133a149cf5 -->
<!-- 出现于 2 处: match_pipe::reviewer::full::bytedance::reviewer_user_bytedance, match_pipe::planner_direct_review::reviewer::bytedance::reviewer_user_bytedance -->
...
<!-- UID: sec-da629a5c263da9e9 -->
<!-- 出现于 2 处: match_pipe::reviewer_followup::writer::upgrade_prompt, match_pipe::reviewer_followup::writer::bytedance::upgrade_prompt -->
请把下面这份历史简历做一次面向目标 JD 的升级式重写，而不是仅做字面修补。
...
<!-- UID: sec-8c4ef23125ace46a -->
<!-- 出现于 1 处: match_pipe::planner::planner::planner_system -->
...
<!-- UID: sec-4128d9a5d046f641 -->
<!-- 出现于 1 处: match_pipe::planner::planner::planner_user -->
...
<!-- UID: sec-bc06ebd68fa92621 -->
<!-- 出现于 1 处: match_pipe::planner::planner::planner_context -->
## Planner 输入
- 目标模式: {mode}
- 公司: {company}
- 职位: {title}
...
<!-- UID: sec-42a29a343c75ce46 -->
<!-- 出现于 2 处: match_pipe::planner_write::writer::planner_writer_context, match_pipe::planner_write::writer::bytedance::planner_writer_context -->
## Planner Decision
```json
{planner_json}
```
...
<!-- UID: sec-f97d39029df3ba7b -->
<!-- 出现于 2 处: match_pipe::planner_write::writer::planner_writer_overlay, match_pipe::planner_write::writer::bytedance::planner_writer_overlay -->
...
<!-- UID: sec-657ebd37247adc02 -->
<!-- 出现于 2 处: match_pipe::planner_revision::writer::planner_revision_context, match_pipe::planner_revision::writer::bytedance::planner_revision_context -->
...
<!-- UID: sec-18aa0a100f253bce -->
<!-- 出现于 2 处: match_pipe::planner_revision::writer::planner_revision_overlay, match_pipe::planner_revision::writer::bytedance::planner_revision_overlay -->
...
<!-- UID: sec-576dfd0a1078f82f -->
<!-- 出现于 1 处: source_reference::inactive_builder::revision_writer::source_reference::inactive_builder::revision_writer::user -->
请按照以下审查结果，对简历进行精准修改。
目标岗位: {title}

---

<!-- UID: sec-6009fcab2a82701c -->
<!-- 出现于 1 处: source_reference::inactive_builder::revision_writer::source_reference::inactive_builder::revision_writer::user -->
## 当前评分: 88.4/100（目标: 93 分以上）

---

<!-- UID: sec-e4e5cda68cf07446 -->
<!-- 出现于 1 处: source_reference::inactive_builder::revision_writer::source_reference::inactive_builder::revision_writer::user -->
## 原始技术分配 PLAN（revision 必须遵守此规划，不得凭空引入计划外技术）

---

<!-- UID: sec-fa4a329406c8e8d8 -->
<!-- 出现于 1 处: source_reference::inactive_builder::revision_writer::source_reference::inactive_builder::revision_writer::user -->
## 最终 PLAN
...
<!-- UID: sec-1d9337dee8d05c8b -->
<!-- 出现于 2 处: source_reference::inactive_builder::revision_writer::source_reference::inactive_builder::revision_writer::user, source_reference::indirect_runtime::seed_retarget_writer::source_reference::indirect_runtime::seed_retarget_writer::user -->
## Achievements
* China national certified Go **2-dan** — city **champion** (2022) and third place (2023).
...
<!-- UID: sec-8dfa5bc8aa9af638 -->
<!-- 出现于 1 处: source_reference::indirect_runtime::seed_retarget_writer::source_reference::indirect_runtime::seed_retarget_writer::user -->
你正在基于一份已经通过高标准审查的 seed resume，为新的 JD 生成派生简历。
...
<!-- UID: sec-57a73cc2a3394c89 -->
<!-- 出现于 1 处: source_reference::indirect_runtime::seed_retarget_writer::source_reference::indirect_runtime::seed_retarget_writer::user -->
## Seed 简历

---

<!-- UID: sec-63a89ada597fd6ca -->
<!-- 出现于 1 处: source_reference::indirect_runtime::seed_retarget_writer::source_reference::indirect_runtime::seed_retarget_writer::user -->
## Professional Summary
...
<!-- UID: sec-27a1deb32a7404d4 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
...
<!-- UID: sec-2ddd96515a0ee3df -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
## Prompt Assembly Index

---

<!-- UID: sec-5b2e0842d180f3d1 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Writer Family

---

<!-- UID: sec-a2f1b555e945edd8 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `P-WRITER-SYS-MAIN`
- 角色：`Writer / 主生成`
- 运行位置：
...
<!-- UID: sec-74354dcf4176dab3 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Reviewer Family

---

<!-- UID: sec-027f02c2ee174199 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `P-REVIEWER-SYS-MAIN`
- 角色：`Reviewer / 主审查`
- 运行位置：
...
<!-- UID: sec-85a2d278e0e360ff -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Planner Family

---

<!-- UID: sec-9a708f3dbbb5b370 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `P-PLANNER-SYS-MAIN`
...
<!-- UID: sec-78c7ec55d35649d6 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### match_pipe Overlay Family

---

<!-- UID: sec-45671a5a441e611f -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
...
<!-- UID: sec-6945e85aa5a491be -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Test Anchor

---

<!-- UID: sec-4e17d75b4b7dda1d -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
...
<!-- UID: sec-a3c8fe0115ff1800 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
## Canonical Block Library

---

<!-- UID: sec-a195d93b34dbcd6d -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Shared Output Contract

---

<!-- UID: sec-905d0d1295d4422e -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-OUTPUT-001`
- 类型：共享单句
...
<!-- UID: sec-57aaeb049fe40076 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Shared Context Blocks

---

<!-- UID: sec-2a9e7ae827dc6c9c -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-IMMUTABLE-001`
- 类型：共享约束块
...
<!-- UID: sec-20a95cd3c8ce9e17 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Writer System Blocks

---

<!-- UID: sec-580385ee89310001 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-WRITER-SYS-001`
- 类型：Writer system
- 全局映射：
...
<!-- UID: sec-eea8a2c84ba1ee01 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Writer User Blocks

---

<!-- UID: sec-8ee854884df2fabe -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-WRITER-USER-001`
- 类型：主生成 prompt 的静态头部
- 全局映射：
...
<!-- UID: sec-135d32321ec2f69e -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Reviewer Blocks

---

<!-- UID: sec-4fbcc00d1b354418 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-REVIEWER-SYS-001`
- 类型：Reviewer system
- 全局映射：
...
<!-- UID: sec-2c3ff2065ce0d835 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Planner Blocks

---

<!-- UID: sec-eb3aca09aabc76ea -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-PLANNER-SYS-001`
- 类型：Planner system
- 全局映射：
...
<!-- UID: sec-6f1b2732810394c1 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### match_pipe Overlay Blocks

---

<!-- UID: sec-7b4a326d2c999a8c -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `B-MATCH-OVERLAY-001`
...
<!-- UID: sec-6f0d18e66a598bc2 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
### Generated Source-Owned Blocks

---

<!-- UID: sec-eb4dc6f49f96f205 -->
<!-- 出现于 1 处: source_reference::doc::prompt_canonical_review::source_reference::doc::prompt_canonical_review::document -->
#### `G-DATA-001`
...
<!-- UID: sec-4fe242576ba1698d -->
<!-- 出现于 1 处: source_reference::doc::match_pipe_prompt_review::source_reference::doc::match_pipe_prompt_review::document -->
...
<!-- UID: sec-8f790ffcc5ae4f46 -->
<!-- 出现于 1 处: source_reference::design_guide::task_general_prompt::source_reference::design_guide::task_general_prompt::document -->
...
<!-- UID: sec-ff4056da778aae62 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
...
<!-- UID: sec-29c50d40b271abf0 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
## 召回路 1：精确 pattern 召回

---

<!-- UID: sec-2f5314db4650f6aa -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
### 目标
...
<!-- UID: sec-17424d92b0c0b3d6 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
## 召回路 2：硬要求单元召回

---

<!-- UID: sec-677cbab5f0ed51ab -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
### 目标
...
<!-- UID: sec-075791ca6850a3d5 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
## 召回路 3：高价值组合召回

---

<!-- UID: sec-76c4f1f4a5c1ee11 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
### 目标
解决高频硬要求太泛的问题。
...
<!-- UID: sec-1fd8c08f0af518ea -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
## 召回路 4：表面表达近邻召回

---

<!-- UID: sec-6d48a57ea5e7d533 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
### 目标
兜底处理：
...
<!-- UID: sec-90f8f8bfaf20bb52 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
## 召回路 5：层级扩展召回

---

<!-- UID: sec-d651e00224d8928f -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
### 目标
...
<!-- UID: sec-89123acf905e6569 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
## 查询岗位

---

<!-- UID: sec-9b6117c22ddb9797 -->
<!-- 出现于 1 处: source_reference::design_guide::execution_suggestions_prompt::source_reference::design_guide::execution_suggestions_prompt::document -->
### 单元 1
* A
* 硬要求
...
<!-- UID: sec-34c9fd5988bdfec6 -->
<!-- 出现于 1 处: source_reference::test_fixture::prompt_merge_equivalence::source_reference::test_fixture::prompt_merge_equivalence::python_source -->
