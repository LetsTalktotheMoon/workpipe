...
## About the job
Mercury Insurance is a company recognized for its achievements and culture, including being named one of America's Best Midsize Employers for 2026. As a Senior Software Engineer, you will design, develop, and maintain complex software systems, lead agile teams, mentor junior engineers, and ensure the delivery of high-quality software solutions.
...
- Information Systems or other related fields OR equivalent combination of education and experience
...
- Proficient in programming in one or more industry-standard languages (e.g.
- Java
- Python
- Go
- C++
...
- Skilled in relational databases
- NoSQL, and caching solutions
- Experienced in APIs using modern protocols like REST and gRPC
- Proficient in message queuing, data streaming, workflow, and integration frameworks (such as Apache Kafka
- Apache NiFi
- Amazon SQS
- MS MQ
- Apache Camel, etc.)
...
- 6 or more years of experience with Guidewire Policy Center (configurations and integrations)
- 4 or more years of experience with Java/J2EE
- 2 or more years of experience utilizing technologies such as Kafka
- AWS
- S3
- Drools
- Blaze, etc
- 2 or more years of experience with Personal lines products
- 1 or more years of experience with CI/CD tools such as Jenkins
- GUnit, etc
...
**Apply:** https://careers-mercuryinsurance.icims.com/jobs/6087/senior-software-engineer(guidewire)/job?in_iframe=1&mode=apply&iis=LinkedIn&iisn=LinkedIn
**Source:** https://careers-mercuryinsurance.icims.com/jobs/6087/senior-software-engineer(guidewire)/job?in_iframe=1&mode=apply&iis=LinkedIn&iisn=LinkedIn
