...
## About the job
Cambia Health Solutions is committed to creating a person-focused and economically sustainable healthcare system. They are seeking an AI Scientist II to design, develop, and implement data-driven solutions using advanced analytical tools in the healthcare payer domain.
...
- Degree (master's or PhD preferred) in a strongly quantitative field such as Computer Science
- Statistics
- Applied Mathematics
- Physics
- Operations Research
- Bioinformatics, or Econometrics
...
- Contributes to the full life-cycle of modeling, from training or fine-tuning, to model evaluation, to model deployment

**Apply:** https://cambiahealth.wd1.myworkdayjobs.com/External/job/Renton-WA/AI-Scientist-II--Healthcare-_R-6482?source=LinkedIn
**Source:** https://cambiahealth.wd1.myworkdayjobs.com/External/job/Renton-WA/AI-Scientist-II--Healthcare-_R-6482?source=LinkedIn
