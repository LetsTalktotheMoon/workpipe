...
| same/AWS | fail | fail | 90.9 | 是 | P3B-010:high:Overall experience timeline + Education | raw JD 同样要求 `3+ years of non-internship professional software development experience`，而当前简历可见非实习全职时间约 30 个月，难以稳过真实 HR 的 SDE II 首筛。 |
...
| extra/HealthEquity-DotNet | fail | fail | 84.3 | 是 | P2-001:high:Professional Summary, sentence 1<br>P3B-010:high:Professional Summary / overall timeline<br>P3B-011:high:Skills / DiDi Experience | .NET/C# 主栈缺口明显，属于真实招聘中的岗位定义级错配。 |
