...
- Bachelors
- Masters
- PhD, or equivalent experience in relevant fields (Computer Science
- Computer Engineering
- EECS
- AI)
- 2 years of relevant software development experience
- Strong C++
- Python programming and software engineering skills
- Experience with DL frameworks (e.g. PyTorch
- JAX
- TensorFlow
- ONNX) and inference libraries (e.g. TensorRT
- TensorRT-LLM, vLLM
- SGLang
- FlashInfer)
...
- Deep understanding of modern deep learning models and workloads (e.g. Transformers
- Recommenders
- ASR
- TTS
...
**Apply:** https://nvidia.wd5.myworkdayjobs.com/NVIDIAExternalCareerSite/job/US-CA-Santa-Clara/Deep-Learning-Software-Engineer--TensorRT-Performance---New-College-Grad-2026_JR2015071?source=jobboardlinkedin
**Source:** https://nvidia.wd5.myworkdayjobs.com/NVIDIAExternalCareerSite/job/US-CA-Santa-Clara/Deep-Learning-Software-Engineer--TensorRT-Performance---New-College-Grad-2026_JR2015071?source=jobboardlinkedin
