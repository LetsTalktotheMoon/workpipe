...
| same/AWS | fail | pass | 97.5 | 否 | none | raw JD 同样要求 `3+ years of non-internship professional software development experience`，而当前简历可见非实习全职时间约 30 个月，难以稳过真实 HR 的 SDE II 首筛。 |
