...
## About the job
Zendesk is a company that focuses on enhancing customer service experiences through innovative software solutions. They are seeking a Senior Machine Learning Engineer to drive the development and deployment of advanced data science and machine learning solutions, particularly leveraging large language models and deep learning.
...
- Java
- Scala, or similar also valued)
- Proven ability to build and optimize scalable data science solution, end-to-end from data pipelines (dbt
- Astronomer
- Snowflake
- AWS) to deployment and monitoring (Docker
- Kubernetes
- CI/CD
...
- Data Science, or related discipline
...
- Act as a subject matter expert, collaborating with data scientists
- ML engineers, analysts, and business stakeholders to understand needs, define requirements, and deliver practical solutions with measurable business impact
...
- Stay abreast of the latest industry advancements in ML
- LLMs, deep learning, cloud data engineering, and MLOps solutions (AWS
- Kubernetes
- Snowflake, etc.)
- Fostering technical excellence and ensuring alignment with business objectives

**Apply:** https://zendesk.wd1.myworkdayjobs.com/en-US/zendesk/job/San-Francisco-California-United-States-of-America/Senior-Machine-Learning-Engineer---Hybrid--San-Francisco-or-Austin-_R34578?source=LinkedIn
**Source:** https://zendesk.wd1.myworkdayjobs.com/en-US/zendesk/job/San-Francisco-California-United-States-of-America/Senior-Machine-Learning-Engineer---Hybrid--San-Francisco-or-Austin-_R34578?source=LinkedIn
